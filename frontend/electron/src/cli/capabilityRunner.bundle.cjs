...
var NODE_TYPES, NODE_STATUSES, NODE_TYPE_LEVEL, ALLOWED_RECORD_KINDS, FM_OPEN, FM_CLOSE_RE;
var init_yamlNoteBlock = __esm({
  "src/services/lego_blocks/units/yamlNoteBlock.ts"() {
    "use strict";
    init_js_yaml();
    init_dist_node();
...
var init_memorizedSessionsBlock = __esm({
  "src/services/lego_blocks/units/memorizedSessionsBlock.ts"() {
    "use strict";
    init_yamlNoteBlock();
  }
