export interface SqlMigrationBlock {
  migrationId: string
  sql: string
}

export const HIERARCHY_MIGRATIONS_BLOCK: SqlMigrationBlock[] = [
  {
    migrationId: '0001_hierarchy_core',
    sql: `
...
`.trim(),
  ...
  {
    migrationId: '0003_add_node_kind',
    sql: `
