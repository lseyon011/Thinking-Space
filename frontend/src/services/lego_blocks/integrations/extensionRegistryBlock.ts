import type { ExtensionManifest } from '@/services/lego_blocks/units/extensionManifestBlock'
import type { ExtensionDeclarativeAction } from '@/services/lego_blocks/integrations/extensionActionBlock'
